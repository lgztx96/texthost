...
constexpr auto ITH_DLL_X86 = L"x86\\texthook"; // .dll but LoadLibrary automatically adds that
constexpr auto ITH_DLL_X64 = L"x64\\texthook"; // .dll but LoadLibrary automatically adds that
